...
<body>
    ...
    <div class="col-lg-12">
        ...
        <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered table-hover table-responsive" AutoGenerateColumns="False" Width="100%" Font-Names="Arial" Font-Size="Small">
            <Columns>
                ...
                <asp:templateField>
                <ItemTemplate>
                   <asp:LinkButton ID="LinkButton1" runat ="server"  class="btn btn-default" OnClick="dataShow" CommandArgument='<%# Eval("employee_id")%>'>Change Password</asp:LinkButton>
                </ItemTemplate>
            </asp:templateField>
                </Columns>
        </asp:GridView>
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:Excalibur %>" SelectCommand="SELECT * FROM [employee_tbl]"></asp:SqlDataSource>
    </div>
</div>
    </form>
</body>
