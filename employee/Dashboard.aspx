...
<form id="form1" runat="server" autocomplete="off">
	<div id="wrapper">
        ...
        <br />
			...
			<br />
                <asp:button id="btnTimeinIN" cssclass="btn btn-warning btn-lg btn-block" runat="server" text="Clock In" ValidationGroup="ForTimeIn" />
			</div>
			<div class="col-xs-6">
			<asp:TextBox ID="fortimeout" runat="server"  CssClass="form-control" ValidationGroup="ForTimeOUT" ReadOnly="True">TimeOut</asp:TextBox>
			  <br />
              <asp:Button ID="btnTimeOut" CssClass="btn btn-danger btn-lg btn-block" runat="server" Text="Clock Out" ValidationGroup="ForTimeOUT" />
			</div>
			</div>
			</div>
			</div>
