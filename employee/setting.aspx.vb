...
Public Class setting
    ...
    Protected Sub btnAddVehicle_Click(sender As Object, e As EventArgs) Handles btnAddVehicle.Click
        ...
        Dim id As Integer = Val(employee_id.Value)

        Dim ad As String = "UPDATE employee_tbl SET username = @username, password = @password WHERE employee_id = @id"
