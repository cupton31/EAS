...
<body id="animated">
    ...
    <div id="register">
        ...
        <tr>
         ...
         <tr>
            <td><asp:Label ID="Label9" runat="server" Text="Mailing Address:"></asp:Label></td>
             <td ><asp:TextBox ID="address" runat="server"> </asp:TextBox></td>
             <td><asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" foreColor="red" ErrorMessage="*Address" ValidationGroup="valAdd" ControlToValidate="address"></asp:RequiredFieldValidator></td>
        </tr>
          <tr>
	  ...
	  <td></td>
        ...
        <div id="login">
            <h1 style="border-bottom:1px solid #ccc"">LOG-IN</h1>
            <table id="tablelogin">
		        <tr>
		        <td><asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Username:"></asp:Label></td>
	           ...
	           <tr>
                <td><asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Password:"></asp:Label></td>
		        ...
		        <tr><td></td>
                <td><asp:Button ID="btnLogin" Font-Bold="true" CssClass="btn btn-primary" runat="server" Text="Login" ValidationGroup="valLog"/>
                ...
                <tr><td></td><td><asp:LinkButton ID="LinkButton1" runat="server" OnClick="ForgotPassword_Click" >Forgot Username or Password?</asp:LinkButton></td></tr>
		     </table>
